...
@discardableResult
public func DirectoryCreateAt(path: String) -> Bool {
    do {
        try FileManager.default.createDirectory(atPath: path, withIntermediateDirectories: true, attributes: nil)
        return true
    } catch {
        Logs.weak << Utils.Log.Event(category: Utils.Log.Category.fileSystem, error: error)
    }
    return false
}
...
public func HomeDirectory(folder: String, file: String? = nil) -> String {
