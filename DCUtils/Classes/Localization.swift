...
extension Notification.Name {
    public static let localizationChanged = Notification.Name("Notification.Name_localizationChanged")
}
...
public class Localization {
    ...
    public static func setCurrent(localization newValue: Localization, notify aNotify: Bool = true) {
        ...
        if notify {
            Notification.post(name: .localizationChanged, object: nil, userInfo: nil)
        }
    }
